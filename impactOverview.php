...
if ($result->num_rows== 0 )
	...
	else
	{
		...
		echo"</b></h1></center><br>";
        	...
        	echo "<th>PCM LAB [25]</th>";
        	echo "<th>RESKILLING LAB [25]</th>";
        	echo "<th>COMPUTER LAB 3 [25]</th>";
        	echo "<th>COMPUTER LAB 4 [25]</th>";
...
else if($row[0]=="PCM LAB")
{
	$resultset['r7']=$row[1];
}
else if($row[0]=="RESKILLING LAB")
{
	$resultset['r8']=$row[1];
}
else if($row[0]=="COMPUTER LAB 3")
{
	$resultset['r9']=$row[1];
}
else if($row[0]=="COMPUTER LAB 4")
{
	$resultset['r10']=$row[1];
...
function getResourceName(string $short)
{
    ...
    {
        $resourceFullName = "COMPUTER LAB 1";
    }
    else if($short =="r6")
    {
        $resourceFullName = "COMPUTER LAB 2";
    }
    else if($short =="r7")
    {
        $resourceFullName = "PCM LAB";
    }
    else if($short =="r8")
    {
        $resourceFullName = "RESKILLING LAB";
    }
    else if($short =="r9")
    {
        $resourceFullName = "COMPUTER LAB 3";
    }
    else if($short =="r10")
    {
        $resourceFullName = "COMPUTER LAB 4";
    }
