...
{
//echo "  ".$v++;
    if($row[0]=="ANALOG LAB 1")
{
	$resultset['r1']=$row[1];
}
 else if($row[0]=="DIGITAL LAB 2")
{
	$resultset['r2']=$row[1];
}
 else if($row[0]=="PROJECT LAB")
{
    $resultset['r3']=$row[1];
}
else if($row[0]=="INSTRUMENTATION LAB")
{
	$resultset['r4']=$row[1];
}
else if($row[0]=="COMMUNICATION LAB")
{
	$resultset['r5']=$row[1];
}
else if($row[0]=="POWER LAB 1")
{
	$resultset['r6']=$row[1];
}
else if($row[0]=="POWER LAB 2")
{
	$resultset['r7']=$row[1];
}
else if($row[0]=="DIGITAL LAB 1")
{
	$resultset['r8']=$row[1];
}
else if($row[0]=="ANALOG LAB 2")
{
	$resultset['r9']=$row[1];
}
else if($row[0]=="PCB LAB")
{
	$resultset['r10']=$row[1];
...
function getResourceName(string $short)
{
    ...
    if($short =="r1")
    {
        $resourceFullName = "ANALOG LAB 1";
    }
    else if($short =="r2")
    {
        $resourceFullName = "DIGITAL LAB 2";
    }
    else if($short =="r3")
    {
        $resourceFullName = "PROJECT LAB";
    }
    else if($short =="r4")
    {
        $resourceFullName = "INSTRUMENTATION LAB";
    }
    else if($short =="r5")
    {
        $resourseFullName= "COMMUNICATION LAB";
    }
    else if($short =="r6")
    {
        $resourceFullName = "POWER LAB 1";
    }
    else if($short =="r7")
    {
        $resourceFullName = "POWER LAB 2";
    }
    else if($short =="r8")
    {
        $resourceFullName = "DIGITAL LAB 2";
